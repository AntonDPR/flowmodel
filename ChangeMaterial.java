...
public class ChangeMaterial {
    ...
    public void setIdMaterial(int index) {
        switch(index) {
            case 0: getIdMaterialFromDatabase();
                    break;
            case 1: getMaxIdMaterialFromDatabase();
        }
    }
    ...
    public void setMaterialType() {
        ...
        material_type = MaterialType.nextLine();*/
        material_type = "Поливинилхлорид";
    }
    ...
    public static void main(String[] args) throws InterruptedException{
        ChangeMaterial app = new ChangeMaterial();
        app.changeDbRecords();
        Thread.sleep(30000);
        app.changeDbRecords();
        Thread.sleep(30000);
